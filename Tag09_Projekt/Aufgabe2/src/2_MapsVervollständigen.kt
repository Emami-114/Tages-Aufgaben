fun main() {
    ...
    //  "Bernd" -> 3465081
    //  "Ludolf" -> 3985ß29
    val telefonNummerListe: Map<String, Int> = mapOf("Peter" to 2487503,"Bernd" to 3465081,"Ludolf" to 398529)
    ...
    //  "Tina" -> 9834620
    //  "Lorelei" -> 4698302
    val stringZuInt: Map<String, Int> = mapOf("Mara" to 3468789,"Tina" to 9834620,"Lorelei" to 4698302)
    println(stringZuInt)
