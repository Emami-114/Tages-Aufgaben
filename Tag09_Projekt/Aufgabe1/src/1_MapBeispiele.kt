fun main() {
    ...
    // Hier entfernen wir Hans.
    personZuAlter.remove("Hans")
    println("8. $personZuAlter")

    // Außerdem können wir alle Schlüssel einer Map mit der function keys() abfragen.
    val keys: List<String> = personZuAlter.keys.toList()
    println("9. $keys")

    // oder alle Werte.
    val values: List<Int> = personZuAlter.values.toList()
    println("10. $values")
}